...
model = model_from_json(open("models/video/model.json", "r").read())
model.load_weights('models/video/model.h5')

face_cascade = cv2.CascadeClassifier('models/video/haarcascade_frontalface_default.xml')
